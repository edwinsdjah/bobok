...
const Navlink = () => {
  ...
  return (
    <>
      {session?.user ? (
        <div className='flex items-center justify-end md:order-2 gap-5'>
          <div className='hiden text-sm bg-gray-50 border rounded-full md:me-0 md:block focus:ring-4 focus:ring-gray-300'>
            <Image
      ...
      >
        <ul className='flex flex-col font-sembild text-sm-uppercase p-4 mt-4 rounded-sm bg-gray-50 md:flex-row md:item-center md:space-x-10 md:p-0 md:mt-0 md:border-0 md:bg-white'>
          <li>
            <Link
              href='/'
