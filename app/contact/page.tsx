...
const ContactPage = () => {
  return (
    <div>
      <HeaderSection title='Contact Us' subTitle='lorem ipsum'></HeaderSection>
        ...
        <div className='grid md:grid-cols-2 gap-8'>
          <div>
            ...
            <p className='text-gray-700 py-5'>
              ...
              autem facere accusantium assumenda, ullam nobis.
            </p>
            <ul className='list-item space-y-6 pt-8'>
              ...
              <li className='flex gap-5'>
                ...
                <div className='flex-1'>
                  ...
                  <p>+62 77882 88912, +62 7998 7764 123 </p>
                </div>
              </li>
              <li className='flex gap-5'>
                <div className='flex-none bg-gray-300 p-3 shadow-sm rounded-sm'>
                ...
                <div className='flex-1'>
                  ...
                  <p>Coderx Street Road 2025, JKT, INDONESIA</p>
                </div>
              </li>
            </ul>
          </div>
